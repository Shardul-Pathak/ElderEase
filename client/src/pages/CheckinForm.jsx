...
export default function CheckInForm() {
  ...
  const handleSubmit = async () => {
    await addLog(mood, medTaken, sleep, water, activity);
  }
  ...
  return (
    <div className="min-h-screen bg-[#f0f7f7] flex flex-col items-center py-10 px-4">
      ...
      <div className="w-full max-w-3xl bg-white shadow-lg rounded-2xl p-6 space-y-6">
        ...
        <button onClick={handleSubmit} className="w-full py-3 bg-teal-700 text-white font-semibold text-lg rounded-xl">
          SUBMIT CHECK-IN
        </button>
        <a href="/checkin">
